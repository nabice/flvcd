...
$replace_str = '<form target="flvcd" action="/" method="POST"><input type="hidden" name="url" value="'.$url.'"/><input id="nabice_tv" class="button" style="width:100%;height:50px;border: 0px none;background-color:#eee;" type="submit" value="Play On TV" onclick="this.style.display=\'none\';"/></form><iframe style="width:0;height:0;display:none" name="flvcd" id="flvcd"></iframe><script>setTimeout("document.getElementById(\'nabice_tv\').style.display=\'none\';", 30000);</script>';
